(function (global) {
  ...
  // 디어데이클래스는 전부 무료 행사라 결제 계좌 프리셋을 쓰지 않습니다.
  ...
  function courseThumbnail(course) {
    // 디어데이는 회차마다 카드 그림(cardImg)이 따로 있습니다.
    // 강연 자체 썸네일이 없으면 빈 값을 주고, 카드 쪽에서 회차 그림을 씁니다.
    return usableThumbnail(course && course.thumbImg);
  }
